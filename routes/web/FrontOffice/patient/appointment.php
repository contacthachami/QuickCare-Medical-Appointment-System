...
Route::middleware(['auth', 'patient'])->group(function () {
    ...
    Route::post('/patient/doctor/{D_ID}/book/appointment/{P_ID}/submit', [PatientController::class, 'bookAppointment'])
    ...
    Route::get('/patient/my/appointments/{id}', [PatientController::class, 'patient_appointments'])
        ->middleware('CheckPatientId')
        ->name('patiens.my.appointments');

    Route::get('/patient/appointment/detail/{id}', [PatientController::class, 'appointment_detail'])
        ->middleware('CheckAppointment')
        ->name('patiens.appointment.detail');

    Route::put('/patient/appointment/detail/{id}/cancel', [PatientController::class, 'cancel_appointment'])
        ->middleware('CheckAppointment')
        ->name('patiens.appointment.detail.cancel');
